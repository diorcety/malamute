...
NAN_METHOD (MlmProto::_set_id) {
    ...
    //int id; // bjornw typedef - if using c_type, then you get 'int * major' but it needs to be 'int major'. later using the FromJust() returns an int
    int id;
...
NAN_METHOD (MlmProto::_set_timeout) {
    ...
    //uint32_t timeout; // bjornw typedef - if using c_type, then you get 'int * major' but it needs to be 'int major'. later using the FromJust() returns an int
    uint32_t timeout;
...
NAN_METHOD (MlmProto::_set_status_code) {
    ...
    //uint16_t status_code; // bjornw typedef - if using c_type, then you get 'int * major' but it needs to be 'int major'. later using the FromJust() returns an int
...
NAN_METHOD (MlmProto::_set_amount) {
    ...
    //uint16_t amount; // bjornw typedef - if using c_type, then you get 'int * major' but it needs to be 'int major'. later using the FromJust() returns an int
    uint32_t amount;
